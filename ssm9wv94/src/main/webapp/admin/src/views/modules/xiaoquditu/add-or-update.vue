<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="建筑名称" prop="jianzhumingcheng">
          <el-input v-model="ruleForm.jianzhumingcheng" 
              placeholder="建筑名称" clearable  :readonly="ro.jianzhumingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="建筑名称" prop="jianzhumingcheng">
              <el-input v-model="ruleForm.jianzhumingcheng" 
                placeholder="建筑名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xiaoquditu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoqudituCrossAddOrUpdateFlag = false;
                  this.parent.search();
