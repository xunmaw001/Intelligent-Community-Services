<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="户型" prop="huxing">
          <el-select v-model="ruleForm.huxing" placeholder="请选择户型">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="入住状态" prop="ruzhuzhuangtai">
          <el-select v-model="ruleForm.ruzhuzhuangtai" placeholder="请选择入住状态">
            <el-option
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.huxingOptions = "电梯房,步梯房".split(',')
            this.ruzhuzhuangtaiOptions = "未入住,已入住".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
