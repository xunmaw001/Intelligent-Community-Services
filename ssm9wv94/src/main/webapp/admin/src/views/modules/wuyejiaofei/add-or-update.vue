<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宽带费" prop="kuandaifei">
          <el-input v-model="ruleForm.kuandaifei" 
              placeholder="宽带费" clearable  :readonly="ro.kuandaifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宽带费" prop="kuandaifei">
              <el-input v-model="ruleForm.kuandaifei" 
                placeholder="宽带费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="燃气费" prop="ranqifei">
          <el-input v-model="ruleForm.ranqifei" 
              placeholder="燃气费" clearable  :readonly="ro.ranqifei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="燃气费" prop="ranqifei">
              <el-input v-model="ruleForm.ranqifei" 
                placeholder="燃气费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="缴费时间" prop="jiaofeishijian">
          <el-input v-model="ruleForm.jiaofeishijian" 
              placeholder="缴费时间" clearable  :readonly="ro.jiaofeishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="缴费时间" prop="jiaofeishijian">
              <el-input v-model="ruleForm.jiaofeishijian" 
...
export default {
  data() {
	...
	userid : false,
      ...
      rules: {
          ...
          kuandaifei: [
                { required: true, message: '宽带费不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          cheweifei: [
          ...
          ranqifei: [
                { required: true, message: '燃气费不能为空', trigger: 'blur' },
                { validator: validateNumber, trigger: 'blur' },
          ],
          zongfeiyong: [
  ...
  computed: {
    zongfeiyong: {
      get: function () {
        return 0+parseFloat(this.ruleForm.wuyefei==""?0:this.ruleForm.wuyefei)+parseFloat(this.ruleForm.shuidianfei==""?0:this.ruleForm.shuidianfei)+parseFloat(this.ruleForm.kuandaifei==""?0:this.ruleForm.kuandaifei)+parseFloat(this.ruleForm.cheweifei==""?0:this.ruleForm.cheweifei)+parseFloat(this.ruleForm.ranqifei==""?0:this.ruleForm.ranqifei) || 0
      }
    },
  },
  created() {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuidianfei = true;
          ...
          if(o=='kuandaifei'){
            this.ruleForm.kuandaifei = obj[o];
	    this.ro.kuandaifei = true;
            continue;
          }
          if(o=='cheweifei'){
	    ...
	    this.ro.cheweifei = true;
          ...
          if(o=='ranqifei'){
            this.ruleForm.ranqifei = obj[o];
	    this.ro.ranqifei = true;
            continue;
          }
          if(o=='zongfeiyong'){
