    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报修问题" prop="baoxiuwenti">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiuwenti" label="报修问题" prop="baoxiuwenti">
                    <span>{{ruleForm.baoxiuwenti}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
